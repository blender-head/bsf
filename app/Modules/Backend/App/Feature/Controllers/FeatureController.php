<?php
	...
	class FeatureController extends BaseBackendController
	{
		...
		public function postCreate(Request $request, FeatureRepository $form_processor, FeatureProcessor $data_processor, Feature $model)
	    {
	    ...
	    public function postEdit(Request $request, FeatureRepository $form_processor, FeatureProcessor $data_processor, Feature $model)
	    {
	    	$form_processor->setOperation('edit');
	    	return $this->startProcess($request, $form_processor, $data_processor, $model);
	    }

	    public function postDelete(Request $request, FeatureRepository $form_processor, FeatureProcessor $data_processor, Feature $model)
	    {
