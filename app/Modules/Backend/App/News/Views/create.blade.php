...
<div class="content">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">Create News Form</h4>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <form id="create-news" role="form" data-op="add" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="news_content"></textarea>
                        </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var op_url = baseUrl + '/news/create';
