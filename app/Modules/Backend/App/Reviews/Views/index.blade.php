	...
	<div class="container">
	    ...
	    <div class="row">
	        <div class="col-sm-12">
	            ...
	            <p class="breadcrumb">
	                <a href="{{ route('reviews.create') }}" type="button" class="btn btn-default waves-effect waves-light">Add New Review</a>
	            </p>
	        </div>
	    </div>
	    	...
	    	<div class="col-sm-12">
	    		<div class="card-box table-responsive">
                    ...
                    <div class="table-wrapper">
                    	<table id="reviews-data" class="table table-striped table-bordered table-actions-bar">
	                    	<thead>
	                            <tr>
...
@section('scripts')
	...
	<script type="text/javascript">
        ...
        var op_url = baseUrl + '/reviews/delete';
        var publish_url = baseUrl + '/reviews/set_status';
        var redirect_url = baseUrl + '/reviews/index';
        var op_source = 'Reviews';
        var delete_url = baseUrl + '/reviews/delete';
        var publish_url = baseUrl + '/reviews/set_status';
        var token = "{{ csrf_token() }}";
        var datatable_el = "#reviews-data";
    </script>
@stop
...
@section('additional_scripts')
    ...
    <script type="text/javascript">
    	...
    	$(document).ready(function() {
      		var datatable_url = baseUrl + '/reviews/index';
