...
<div class="content">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">Edit Reviews Form</h4>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <form id="edit-reviews" role="form" data-op="edit" enctype="multipart/form-data">
                        
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">

                        <div class="form-group">
                            <label>Title <span class="red">*</span></label>
                            <input type="text" name="title" class="form-control" placeholder="Enter reviews title" value="{{ $review->title }}">
                        </div>

                        <div class="form-group">
                            <label>Content <span class="red">*</span></label>
                            <textarea class="reviews_content">{{ $review->content }}</textarea>
                        </div>

                        <div class="form-group">
                            <label>Excerpt</label>
                            <textarea class="form-control" name="excerpt">{{ $review->excerpt }}</textarea>
                        ...
                        <div class="form-group">
                        	<div class="row">
                        		<div class="col-sm-6">
	                            	...
	                            	<p><span class="help-text"><em>Featured image is an image that will be displayed on the review's detail page. It must be exactly 950 × 633 in dimension and no more than 200kb in size</em></span></p>                           	
	                            </div>
	                        </div>
                        </div>

                        <div class="form-group">
                        	<img width="40%" id="featured-image-preview" src="{{ $review->filepath }}" />
                        </div>

                        <input type="hidden" name="id" value="{{ $review->id }}">
                        <input type="hidden" name="old_featured_image" value="{{ $review->filename }}">
                        <button type="submit" class="btn btn-success waves-effect waves-light">Save</button>
                        <a href="{{ url('/') }}/{{ $be_prefix }}/reviews/index" class="btn btn-success waves-effect waves-light">Cancel</a>
                    </form>
...
@section('scripts')
    ...
    <script type="text/javascript">
        var form_element = '#edit-reviews';
        var data_selector = 'reviews';
        var op_url = baseUrl + '/reviews/edit';
